...
class AliceDataset(Dataset):
    ...
    def __init__(self, background_file: str = '', background_xs = 1.6270497, signal_component = msq.Component.SIG, background_component = msq.Component.BKG, sample_size = 10000, offset = 0):
        super().__init__()
