...
class BalancedDataModule(L.LightningDataModule):
    ...
    def prepare_data(self):
        ...
        sample_sig = sample.from_csv(0.1, os.path.join(self.data_dir, self.signal_file), n_rows=self.sample_size*10)
        sample_bkg = sample.from_csv(1.6, os.path.join(self.data_dir, self.background_file), n_rows=self.sample_size*10)
